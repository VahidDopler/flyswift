...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('airplans', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Airport',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_of_cancel', models.PositiveIntegerField(blank=True, default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('unique_id', models.CharField(blank=True, default='', max_length=200)),
                ('capacity', models.PositiveIntegerField(default=40, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)])),
                ('count_of_reserved', models.PositiveIntegerField(default=0)),
                ('airplane', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='flights', to='flight.airplane')),
                ('created_by_user', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
